<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Structure.aspx.cs" Inherits="Structure" %>
                        ...
                        <table cellspacing="0" cellpadding="0" width="90%" border="0">
                            <tr>
                                <td class="cmscontent" valign="top">
                                    <div align="left">
                                        <p>
                                            <asp:Label ID="Label1" runat="server">名城名校深度融合发展，强强联合打造一流标杆。站在新时代的新起点，南京大学金陵学院将继续追逐新的愿景，谱写新的华章，创造新的辉煌！  </asp:Label>&nbsp;</p>
                                    </div>
                                </td>
                            </tr>
                        </table>
